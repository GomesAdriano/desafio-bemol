        ...
        <div className="main_container">
            <div className="grid content">
                <div className="box box-left">
                    <img src="/register.png" alt="Login" className="imagem" />
                </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="form-width">
                        <div className="flex-column">
                            ...
                            <div className="errors-box">
                                ...
                                {cpfInvalid && (
                                    <span className="errors">Informe um CPF válido</span>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex-column">
                            ...
                            <div className="errors-box">
                                {errors.nome_completo && (
                                    <span className="errors">{errors.nome_completo.message}</span>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex-column">
                            ...
                            <div className="errors-box">
                                {errors.telefone && (
                                    <span className="errors">{errors.telefone.message}</span>
                                )}
                                {telefoneInvalid && (
                                    <span className="errors">Informe um telefone válido</span>
                                )}
                            </div>
                        </div>
                        <div className="flex-column">
                        ...
                        <div className="flex-column">
                            ...
                            <div className="errors-box">
                                {errors.repetir_senha && (
                                    <span className="errors">{errors.repetir_senha.message}</span>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex-column mb-2">
                            ...
                            <div className="errors-box">
                                ...
                                {cepInvalid && (
                                    <span className="errors">Informe um CEP válido</span>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex-column">
                            ...
                            <div className="errors-box">
                                {errors.logradouro && (
                                    <span className="errors">{errors.logradouro.message}</span>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex-column">
                            ...
                            <div className="errors-box">
                                {errors.numero && (
                                    <span className="errors">{errors.numero.message}</span>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex-column">
                            ...
                            <div className="errors-box">
                                {errors.complemento && (
                                    <span className="errors">{errors.complemento.message}</span>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex-column">
                            ...
                            <div className="errors-box">
                                {errors.bairro && (
                                    <span className="errors">{errors.bairro.message}</span>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex-column">
                            ...
                            <div className="errors-box">
                                {errors.cidade && (
                                    <span className="errors">{errors.cidade.message}</span>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex-column">
                            ...
                            <div className="errors-box">
                                {errors.estado && (
                                    <span className="errors">{errors.estado.message}</span>
                                )}
                            </div>
                        </div>

                        <div className="buttons">
                            <Button variant="primary" type="submit" className="button-cadastro">
                                Cadastrar
                            </Button>
                            <div>
